...
Item {
    ...
    Image {
        id: coffeeImage
        width: parent.width / 2.5 // Calculated based on an aspect ratio of 4:3
    ...
    SequentialAnimation {
        ...
        ScriptAction {
            script: {
                stackview.push({ item: Qt.resolvedUrl("qrc:/BrewSelection.qml"), properties: { name: "Latte", image: "qrc:/images/latte.png", coffeeStrength: 3, coffeeVolume: 100, milkVolume: 100 } })
            }
        }
    }
}
